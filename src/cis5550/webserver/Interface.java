...
public class Interface {
	...
	public static final String home_cached = "<!DOCTYPE html>\r\n"
			...
			+ "          errorElem.textContent = \"No results found\";\r\n"
			...
			+ "        timer = setTimeout(() => {\r\n"
			+ "          var query = searchBox.textContent;\r\n"
			+ "          var trimQuery = searchBox.textContent.trim();\r\n"
			+ "\r\n"
			+ "          // Save cursor position\r\n"
			+ "          const currentPosition = getCaretPosition(searchBox);\r\n"
			+ "          var hasSpaceEnd = trimQuery.length < query.length;          \r\n"
			+ "\r\n"
			+ "          // split the query into words\r\n"
			+ "          var words = trimQuery.split(/\\s+/);\r\n"
			+ "          var oldWords = trimQuery.split(/\\s+/);\r\n"
			+ "          \r\n"
			+ "\r\n"
			+ "          // set a flag\r\n"
			+ "          var hasMisspell = false;\r\n"
